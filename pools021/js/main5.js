(function() {
    ...
    window.CanvasSlideshow = function( options ) {
      ...
      /// ---------------------------      
      options                     = options || {};
      options.stageWidth          = options.hasOwnProperty('stageWidth') ? options.stageWidth : 3000;
      options.stageHeight         = options.hasOwnProperty('stageHeight') ? options.stageHeight : 1750;
